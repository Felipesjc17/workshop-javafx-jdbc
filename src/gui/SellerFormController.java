...
public class SellerFormController implements Initializable {
	...
	//// emitindo evento // lista de objetos interessados em receber o evento de
	//// mudança
	...
	public void subscribeDataChanceListener(DataChangeListener listener) { // metodo para se inscrever na lista que
																			// recebera os eventos
	...
	private Seller getFormData() {// pega os dados do formulario instancia obj e passa os dados para esse obj
		...
		obj.setId(Utils.tryParceToInt(txtId.getText()));// passando o Id da caixa para obj já convertido para inteiro ou
														// null se for vazio tratado pela função tryParceToInt

		// se txt name tiver espaço no começo ou final (trim) ou Equals (" ") String
		// vazia, lança exceção
	...
	private void setErrorMessages(Map<String, String> errors) {
		...
		if (fields.contains("name")) { // verificando se a chave é name, confirmando o erro
			labelErrorName.setText(errors.get("name")); // passando conteudo da chave name para o campo de erro da
														// janela
		}
	}
